    ...
    <div class="add_mian">
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item prop="city" label="城市">
          <el-cascader v-model="form.city" :options="regionData" :props="{ value: 'label' }"></el-cascader>
        </el-form-item>
        <!-- 题型 -->
        ...
        <el-form-item :label="typeObj[form.type]" :prop="typeAns[form.type]" label-width="60px">
          <!-- 把单选多选简答抽离出来 -->
